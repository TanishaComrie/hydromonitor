...
class MQTT:
    ...
    sub_topics = [("620156117_pub", 0), ("620156117", 0), ("620156117_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620156117",self.update)
