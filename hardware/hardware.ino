...
#define DHTPIN 36   // what pin we're connected to
...
// MQTT CLIENT CONFIG  
static const char* pubtopic      = "620156117";                    // Add your ID number here
static const char* subtopic[]    = {"620156117_sub","/elet2415"};  // Array of Topics(Strings) to subscribe to
